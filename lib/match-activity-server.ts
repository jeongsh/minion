...
/** 웹과 네이티브가 같은 경기 활동 계산을 사용하도록 인증별 팀 키만 주입받는다. */
export async function getMatchActivityForTeamKeys(followedKeys: string[]): Promise<MatchActivityResponse> {
