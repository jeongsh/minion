  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-col py-0.5">
        ...
        <h3 className="font-paperozi mt-1 line-clamp-2 text-[12px] !font-bold leading-[1.45] tracking-[-0.02em] text-[var(--ui-ink)] group-hover:underline min-[390px]:mt-1.5 sm:text-[18px] sm:leading-[1.4] sm:tracking-[-0.025em]">
          {article.title}
        </h3>
