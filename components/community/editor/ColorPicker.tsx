  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          ref={panelRef}
          className="fixed left-1/2 top-1/2 z-[70] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-surface p-2 md:absolute md:left-0 md:top-full md:z-50 md:translate-x-0 md:translate-y-0 md:rounded-md"
        ...
        >
          ...
          <button
            ...
            className="mb-1.5 w-full rounded border border-border py-0.5 text-[13px] text-muted hover:bg-surface-muted"
          >
            {quickSetLabel}
          </button>
          ...
          <div className="mt-1.5 border-t border-border pt-1.5">
            <button
              type="button"
              className="w-full rounded border border-border py-0.5 text-[13px] text-muted hover:bg-surface-muted"
