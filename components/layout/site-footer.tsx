export function SiteFooter() {
  return <footer className="border-t border-[#dfe0e2] bg-background text-[#18191c] dark:border-[#383c44] dark:text-[#f8f8f8]">
    <div className="mx-auto max-w-[1500px] px-5 py-5 text-left xl:px-10">
      <p className="text-lg font-black tracking-[-.04em]">MINION<span className="text-[#8b8e94]">.</span></p>
      <p className="mt-2 max-w-[1100px] text-xs leading-5 text-[#777b82] dark:text-[#8f98a8]">
      ...
      <p className="mt-1 text-xs leading-5 text-[#777b82] dark:text-[#8f98a8]">
