...
function Card({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 text-[13px] font-semibold text-white/80">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex shrink-0 gap-1">
                <button
                  ...
                  className="rounded border border-white/10 px-1.5 py-0.5 text-[13px] font-bold text-white/60 hover:border-white/30 hover:text-white disabled:opacity-20"
                ...
                <button
                  ...
                  className="rounded border border-white/10 px-1.5 py-0.5 text-[13px] font-bold text-red-400/70 hover:border-red-400/40 hover:text-red-400"
                  aria-label="이 라운드 삭제"
                >
                  삭제
                </button>
