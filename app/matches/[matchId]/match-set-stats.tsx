...
function ComparisonBar({
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] items-center py-1.5">
      ...
      <span className="shrink-0 px-3 text-[12px] font-semibold text-muted">{label}</span>
  ...
  return (
    <div>
      ...
      <div className={`flex items-center gap-3 px-3 py-2 ${headerBg}`}>
        ...
        {won && (
          <span className="rounded bg-accent px-1.5 py-0.5 text-[12px] font-bold text-accent-foreground">승</span>
        )}
        <div className="ml-auto" />
        {/* 컬럼 레이블 */}
        <div className="hidden min-w-[760px] grid-cols-[220px_1fr_140px_50px_70px_220px] gap-3 text-[12px] font-semibold uppercase text-muted md:grid">
          <span />
          <span>KDA</span>
          <span>딜량</span>
