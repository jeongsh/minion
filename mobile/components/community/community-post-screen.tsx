...
export function CommunityPostScreen({ scope = 'hub' }: { scope?: CommunityScope }) {
  ...
  const orderedRoots = useMemo(() => {
    const best = roots
      ...
      .sort((a, b) => (b.likeCount - b.dislikeCount) - (a.likeCount - a.dislikeCount) || b.likeCount - a.likeCount);
    return [...best, ...roots.filter((item) => !item.isBest)];
  }, [roots]);
