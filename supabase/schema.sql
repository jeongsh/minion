...
create table public.match_automation_events (
  id uuid primary key default gen_random_uuid(),
...
create unique index idx_matches_lolesports_match_id on public.matches(lolesports_match_id)
...
create index idx_match_automation_events_pending on public.match_automation_events(created_at)
  where delivered_at is null;
create index idx_match_automation_events_match_id on public.match_automation_events(match_id);
create index idx_match_automation_events_set_id on public.match_automation_events(set_id);
